...
<br><br>
    <div class="container" style="background-color:#E6F7FF;">
        <div>
            <div class="row">
                <H1 style="text-align:center;margin-bottom:20px;">Welcome to the Nagaland</H1>
            </div>
        </div>
        ...
        <div>
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="card">
                        <img class="card-img-top" src="images/kohima.png" alt="Vishakhapatnam">
                        <div class="card-body">
                            <h4 class="card-title">Kohima</h4>
                            <p class="card-text">Travel package for kohima</p>
