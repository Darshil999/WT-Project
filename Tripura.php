...
<br><br>
    ...
    <div class="container" style="background-color:#E6F7FF;">
        <div>
            <div class="row">
                <H1 style="text-align:center;margin-bottom:20px;">Welcome to the Tripura</H1>
            </div>
        </div>
        ...
        <div>
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="card">
                        <img class="card-img-top" src="images/agartala.png" alt="Vishakhapatnam">
                        <div class="card-body">
                            <h4 class="card-title">Agartala</h4>
                            <p class="card-text">Travel package for Agartala</p>
                ...
                <div class="col-sm-4">
                    <div class="card">
                        <img class="card-img-top" src="images/dumboor.png" alt="Puducherry" style="height:190px;">
                        <div class="card-body">
                            <h4 class="card-title">Dumboor</h4>
                            <p class="card-text">Travel package for dumboor</p>
                            <p class="price">Rs. 10000</p> <!-- Add a price element -->
                            <a href="#" class="btncart" data-price="10000">add to cart</a>
                        </div>
                    </div>
